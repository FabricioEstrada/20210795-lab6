...
-- -----------------------------------------------------
DROP DATABASE IF EXISTS `lab6_20210795`;
CREATE SCHEMA IF NOT EXISTS `lab6_20210795` DEFAULT CHARACTER SET utf8mb3 ;
USE `lab6_20210795` ;
-- -----------------------------------------------------
...
INSERT INTO `lab6_20210795`.`peliculas` (`peliculaId`, `titulo`, `fechaEstreno`, `duracionMinutos`) VALUES ('1', 'Joker', '2024-1-3', '200');
INSERT INTO `lab6_20210795`.`directores` (`directorId`, `nombre`, `telefono`, `nacionalidad`) VALUES ('1', 'Nolan', '949294342', 'USA');
